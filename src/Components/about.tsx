...
export const About = () => {
  return (
    <VStack pb="5">
      ...
      <Text>This tutorial will guide you through the process of generating a custom SVG, posting it to Celestia's data availability layer, retrieving it, and displaying it.</Text>
